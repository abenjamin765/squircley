...
export interface UIControllerElements {
  ...
  curvatureSlider: HTMLInputElement | null;
  curvatureValue: HTMLElement | null;
 ...
 */
export function calculateSuperellipsePoint(
  angle: number,
 ...
 */
export function applyRotation(point: Point, rotation: number): Point {
...
export function generateSuperellipsePath(
  ...
  for (let i = 0; i < 4; i++) {
    ...
    curves.push({
      ...
      cp2: [
        end[0] - (nextTangent.after[0] - nextTangent.before[0]) * controlFactor,
        end[1] - (nextTangent.after[1] - nextTangent.before[1]) * controlFactor,
      ],
      end,
    });
  }
 ...
 */
export function initializeUIController(elements: UIControllerElements): void {
 ...
 */
export function updatePreview(elements: UIControllerElements): void {
 ...
 */
export function updateSliderValue(elements: UIControllerElements): void {
 ...
 */
export function getCurrentCurvature(): number {
 ...
 */
export function setCurrentCurvature(value: number): void {
 ...
 */
export function handleCreateClick(elements: UIControllerElements): void {
  // Add exit animation
 ...
 */
export function handleSliderInput(elements: UIControllerElements): void {
  updateSliderValue(elements);
}
