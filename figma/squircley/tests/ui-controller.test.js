 ...
 */
import { calculateSuperellipsePoint, applyRotation, generateSuperellipsePath, initializeUIController, updatePreview, updateSliderValue, getCurrentCurvature, setCurrentCurvature, handleCreateClick, handleSliderInput, SHAPE_CONSTANTS, } from '../src/ui-controller';
describe('UI Controller', () => {
    ...
    beforeEach(() => {
        ...
        mockElements = {
            ...
            curvatureSlider: document.createElement('input'),
    ...
    describe('UI Interactions', () => {
        ...
        test('handleCreateClick adds exit animation class', () => {
            ...
            if (mockElements.previewSvg) {
                expect(mockElements.previewSvg.classList.contains('exit-animation')).toBe(true);
            }
        });
        test('handleCreateClick resets animation after delay', () => {
            ...
            if (mockElements.previewSvg) {
                expect(mockElements.previewSvg.classList.contains('exit-animation')).toBe(false);
            }
            jest.useRealTimers();
        });
    });
